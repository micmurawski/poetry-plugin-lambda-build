...
ARGS = {
    ...
    "docker-entrypoint": ("The entrypoint for the container (comma separated string)", True, False, "/bin/bash", str),
    ...
    "package-install-dir": ("Installation directory inside artifact for single package", True, False, "", str),
    "function-artifact-path": ("Output function package path. Set the '.zip' extension to wrap the artifact into a zip package otherwise, output will be created in the directory.", True, False, None, str),
    "function-install-dir": ("Installation directory inside artifact for function package", True, False, "", str),
    "layer-artifact-path": ("Output layer package path. Set the '.zip' extension to wrap the artifact into a zip package otherwise, output will be created in the directory.", True, False, None, str),
    "layer-install-dir": ("Installation directory inside artifact for layer package", True, False, "", str),
    ...
    "zip-compresslevel": ("None (default for the given compression type) or an integer "
                          "specifying the level to pass to the compressor. "
                          "When using ZIP_STORED or ZIP_LZMA this keyword has no effect. "
                          "When using ZIP_DEFLATED integers 0 through 9 are accepted. "
                          "When using ZIP_BZIP2 integers 1 through 9 are accepted.", True, False, None, int),
    "zip-compression": ("ZIP_STORED (no compression), ZIP_DEFLATED (requires zlib), ZIP_BZIP2 (requires bz2) or ZIP_LZMA (requires lzma)", True, False, "ZIP_STORED", str),
    "pre-install-script": ("The script that is executed before installation.", True, False, None, str)
}
